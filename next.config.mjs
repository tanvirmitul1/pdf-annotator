...
const nextConfig = {
  output: process.env.DOCKER_BUILD === "1" || process.env.CI_BUILD === "1" ? "standalone" : undefined,
  ...
  serverExternalPackages: ["@napi-rs/canvas", "pdfjs-dist", "sharp", "canvas", "bullmq", "ioredis", "@opentelemetry/instrumentation", "bcrypt", "resend"],
